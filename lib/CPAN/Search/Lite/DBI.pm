...
$tables = {
           mods => {
                    primary => {mod_id => q{MEDIUMINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT}},
                    other => {
                              mod_name => q{VARCHAR(100) NOT NULL},
                              dist_id => q{MEDIUMINT UNSIGNED NOT NULL},
                              mod_abs => q{TINYTEXT},
                              doc => q{bool},
                              src => q{bool},
           ...
           dists => {
                     primary => {dist_id => q{MEDIUMINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT}},
                     other => {
                               dist_name => q{VARCHAR(90) NOT NULL},
                               stamp => q{TIMESTAMP(8)},
                               auth_id => q{MEDIUMINT UNSIGNED NOT NULL},
           ...
           auths => {
                     primary => {auth_id => q{MEDIUMINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT}},
                     other => {
           ...
           chaps => {
                     primary => {chap_id => q{MEDIUMINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT}},
                     other => {
                               dist_id => q{MEDIUMINT UNSIGNED NOT NULL},
                               chapterid => q{TINYINT(2) UNSIGNED},
           ...
           reqs => {
                    primary => {req_id => q{MEDIUMINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT}},
                    other => {
                              dist_id => q{MEDIUMINT UNSIGNED NOT NULL},
                              mod_id => q{MEDIUMINT UNSIGNED NOT NULL},
           ...
           ppms => {
                    primary => {ppm_id => q{MEDIUMINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT}},
                    other => {
                              dist_id => q{MEDIUMINT UNSIGNED NOT NULL},
