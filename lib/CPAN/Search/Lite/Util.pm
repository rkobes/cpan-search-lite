...
#                      },
                 ...
                 5 => {
                       alias => 'AS58',
                       LOCATION  => 
                       'http://ppm4.activestate.com/MSWin32-x86/5.8/818/',
                       SUMMARYFILE  => 'fetch_summary',
                       PerlV         => 5.8,
                       browse => 'http://ppm4.activestate.com/MSWin32-x86/5.8/818/',
                 ...
                 9 => {
                       ...
                       desc => 'trouchelle.com Perl 5.8 repository',
                       build => '8xx',
                       PerlV         => 5.8,
                      },
                 10 => {
                       ...
                       SUMMARYFILE  => 'fetch_summary',
                       PerlV         => 5.10,
                       browse => 'http://ppm4.activestate.com/MSWin32-x86/5.10/1000/',
                       desc => 'ActiveState default Perl 5.10 repository',
                       build => '10xx',
                      },
                 11 => {
                       alias => 'uwinnipeg510',
                       ...
                       SUMMARYFILE  => 'fetch_summary',
                       browse => 'http://cpan.uwinnipeg.ca/PPMPackages/10xx/',
                       desc => 'uwinnipeg Perl 5.10 repository',
                       build => '10xx',
                       PerlV         => 5.10,
                      },
                 12 => {
                       ...
                       SUMMARYFILE  => 'summary.ppm',
                       browse => 'http://ppm.tcool.org/intro/register',
                       desc => 'tcool.org Perl 5.8 repository',
                       build => '8xx',
                       PerlV         => 5.8,
                      },
                 13 => {
                       ...
                       SUMMARYFILE  => 'summary.cgi',
                       browse => 'http://www.bribes.org/perl/ppm',
                       desc => 'www.bribes.org Perl 5.10 repository',
                       build => '10xx',
                       PerlV         => 5.10,
                      },
                 14 => {
                       ...
                       SUMMARYFILE  => 'summary.ppm',
                       browse => 'http://trouchelle.com/perl/ppmrepview.pl',
                       desc => 'trouchelle.com Perl 5.10 repository',
                       build => '10xx',
                       PerlV         => 5.10,
                      },
                 15 => {
                       ...
                       SUMMARYFILE  => 'summary.ppm',
                       browse => 'http://www.wxperl.co.uk/ppm.html',
                       desc => 'wxperl 5.8 repository',
                       build => '8xx',
                       PerlV         => 5.8,
                      },
                  16 => {
